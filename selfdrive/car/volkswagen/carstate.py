...
class CarState(CarStateBase):
  ...
  def update_pq(self, pt_cp, cam_cp, ext_cp, trans_type):
    ...
    # need to work out internal PCMcruise state when using EPB deceleration control
    # stock ECM cancels cruise / goes into state 3 when it see's ECD/EPB signal active
