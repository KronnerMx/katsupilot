...
#define MSG_AWV                 0x366   // RX from radar, TX by OP. Possible FTS (SNG?) signal?
#define MSG_EPB_1               0x5C0   // TX by OP. ECD signal.

// Transmit of GRA_Neu is allowed on bus 0 and 2 to keep compatibility with gateway and camera integration
// Transmit of AWV on 0 only, 2 is from radar
// Transmit of EPB on 1 only, tapped onto PTcan
